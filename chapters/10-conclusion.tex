...
\section{Conclusion}
This thesis has described functionalities provided by PLTRedex, has described how PyPltRedex implements subset of PLTRedex and algorithms used to implement various functionalities. Unfortunately, evaluation of PyPltRedex with respect to performance has suffered due to time constraints.
