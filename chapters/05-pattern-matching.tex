...
\input{chapters/05-pattern-matching-symbol-resolution.tex}
\input{chapters/05-pattern-matching-ident-rewrite.tex}
\input{chapters/05-pattern-matching-ellipsis-depth-check.tex}
\input{chapters/05-pattern-matching-nt-cycle.tex}
