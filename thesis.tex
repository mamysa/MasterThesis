...
\setminted[python]{frame=lines,framerule=1.25pt,framesep=10pt,bgcolor=mintedbg, breaklines=true,fontsize=\normalsize}
\setminted[text]{frame=lines,framerule=1.25pt,framesep=10pt,bgcolor=mintedbg, breaklines=true,fontsize=\normalsize}
