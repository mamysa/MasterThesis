...
\newcommandx{\TermSequence}[2][1=$t_1$, 2=$t_n$]{%
	\mintinline{text}{PatternSequence([|#1|,|$...$|,|#2|] : TermTemplate?)}}
...
\newcommandx{\PythonCall}[4][1=$nt$, 2=$p_1$, 3=$p_n$, 4=true]{%
	\ifthenelse{\boolean{#4}}
...
\newcommandx{\TlDefineMetafunction}[6][1=$n$, 2=$l$, 3=$d$, 4=$c$, 5=$mc_1$, 6=$mc_n$]{%
{\mintinline{text}{DefineMetafunction(|#1|: str, |#2|: str, |#3|: Pattern, |#4|: Pattern, [|#5|, |$...$|, |#5|]: MfCase)}}}
...
\newcommandx{\TlDefineReductionRelation}[5][1=$n$, 2=$l$, 3=$d$, 4=$rc_1$, 5=$rc_n$]{%
...
\newcommandx{\TermLetAssertEqual}[9][1=$v_1$, 2=$n_1$, 3=$t_1$, 4=$n_m$, 5=$n_m$, 6=$t_m$, 7=$t$, 8=$e$, 9=true]{%
...
\newcommandx{\ReadFromStdinAndApplyReductionRelation}[2][1=$red$, 2=$mf$]{%
